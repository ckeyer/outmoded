...
Partial Class NinePic
    ...
    Private Sub InitializeComponent()
        ...
        Me.mypics.Images.SetKeyName(1, "ima (1).png")
        Me.mypics.Images.SetKeyName(2, "ima (2).jpg")
        Me.mypics.Images.SetKeyName(3, "ima (3).jpg")
        Me.mypics.Images.SetKeyName(4, "ima (4).jpg")
        Me.mypics.Images.SetKeyName(5, "ima (5).jpg")
        Me.mypics.Images.SetKeyName(6, "ima (6).jpg")
        Me.mypics.Images.SetKeyName(7, "ima (7).jpg")
        Me.mypics.Images.SetKeyName(8, "ima (9).jpg")
        Me.mypics.Images.SetKeyName(9, "ima (10).jpg")
        Me.mypics.Images.SetKeyName(10, "ima (11).jpg")
        Me.mypics.Images.SetKeyName(11, "ima (12).jpg")
        Me.mypics.Images.SetKeyName(12, "ima (13).jpg")
        Me.mypics.Images.SetKeyName(13, "ima (14).jpg")
        Me.mypics.Images.SetKeyName(14, "ima (15).jpg")
        Me.mypics.Images.SetKeyName(15, "ima (16).jpg")
        Me.mypics.Images.SetKeyName(16, "ima (17).jpg")
        Me.mypics.Images.SetKeyName(17, "ima (18).jpg")
        Me.mypics.Images.SetKeyName(18, "ima (19).jpg")
        Me.mypics.Images.SetKeyName(19, "ima (20).jpg")
        Me.mypics.Images.SetKeyName(20, "ima (21).jpg")
        Me.mypics.Images.SetKeyName(21, "ima (22).jpg")
        '
        'Timerbackgd
        '
